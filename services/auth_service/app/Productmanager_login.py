...
# @router.post("/auth/Productmanager_login", response_model=schemas.TokenResponse)
...
#         logger.warning(f"❌ Unauthorized access attempt for user: {identifier}")
...
#         raise HTTPException(status_code=403, detail="Invalid Product Manager ")
